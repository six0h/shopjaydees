...
describe("loadConfig", () => {
  ...
  function setRequiredEnv() {
    ...
    process.env.CLICKUP_FIELD_COMPANY_PHONE = "field-company-phone";
    process.env.CLICKUP_FIELD_MOBILE = "field-mobile";
    process.env.CLICKUP_FIELD_EXTENSION = "field-extension";
    process.env.CLICKUP_FIELD_OTHER_PHONE_LINES = "field-other-phone-lines";
